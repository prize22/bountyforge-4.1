...
- **Run more than once.** LLM output is non-deterministic GÇö each run can surface different vulnerabilities. Two or three passes over the same code often catch things a single pass misses.
