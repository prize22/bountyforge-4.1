...
# GòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉ
# COMMIT CLASSIFICATION GÇö Intent + Structural Impact model
#
# Two-phase approach:
...
def _analyze_diff_structure(diff_text: str) -> list[tuple[int, str]]:
    ...
    Both adding and removing guards are equally security-interesting GÇö
    ...
    # Guards: require/revert/assert GÇö any change is security-relevant
    ...
    # Access modifiers GÇö tightening and loosening both matter
...
def score_commit(
    ...
    # GöÇGöÇ Phase 1: Intent classification GöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇ
    ...
    # GöÇGöÇ Phase 2: Structural diff analysis GöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇ
    ...
    # GöÇGöÇ Phase 3: Security domain overlap GöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇ
    ...
    # GöÇGöÇ Phase 4: Shape modifiers GöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇ
    shape_score = 0
    ...
    if os.path.isdir(lib_dir):
        for entry in sorted(os.listdir(lib_dir)):
            ...
            if lib_id and lib_id in KNOWN_LIBS:
                ...
                if is_internalized:
                    notes.append(f"Internalized (not a submodule) GÇö may contain modifications from upstream {label}")
            else:
                label = entry
                if is_internalized:
                    notes.append("Internalized (not a submodule) GÇö unknown upstream")
    ...
    for rel_path in blame_files:
        ...
        for bline in blame_out.splitlines():
            ...
            if bline.startswith("author "):
                ...
                # Content line GÇö save blame for this line number
                if current_line > 0:
...
def main() -> int:
    ...
    # Build fileGåÆsecurity-area cache once, shared by fix detection
