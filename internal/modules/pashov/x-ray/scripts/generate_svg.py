...
"row" is optional G«ˆ if omitted, layers are auto-assigned via longest-path.
"subtitle" is optional G«ˆ shown as second line inside box.
"groups" is optional G«ˆ draws an enclosure around the listed nodes.
"""

import json, sys, math
from collections import defaultdict, deque

# Gˆ«Gˆ« Dimensions Gˆ«Gˆ«
ACTOR_H = 14
BOX_H = 20
BOX_RX = 3
PILL_RX = 7
...
# GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…
# LAYER ASSIGNMENT
# GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…
...
def generate(cfg):
    ...
    for i, e in enumerate(edges):
        ...
        if same_row:
            ...
            # Vertical: bottom of source GÂ∆ top of target
            if fy < ty:
                x1, y1 = fx, fy + fh
                x2, y2 = tx, ty
            else:
